...
La guia de entorno esta en [docs/entorno_docker_laradock.md](docs/entorno_docker_laradock.md).
...
Tambien puedes usar Docker/Laradock si quieres trabajar como en los otros proyectos del curso.
